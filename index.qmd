...
*Lorem ipsum dolor* sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua [@begueria2024]. Donec sed odio operae, eu vulputate felis **rhoncus** (`{r} pi |> format_to_md_latex("\\%") %>% paste0("n = ", .) |> I()`). Salutantibus vitae elit libero, a pharetra augue. Nihil hic munitissimus habendi senatus locus, nihil horum? A communi observantia non est recedendum [@einstein1905a].

### Heading 3 {#sec-heading-3}

Quisque ut dolor gravida, placerat libero vel, euismod [@rcoreteama]. Ambitioni dedisse **scripsisse** $`{r} format(10^5, big.mark = ",") |> I()`$ iudicaretur. Donec sed odio operae, eu vulputate felis rhoncus. *Nihilne te nocturnum praesidium Palati, nihil urbis vigiliae* [@einstein1935].
...
Ab illo tempore, ab est sed immemorabili. *Cum sociis natoque penatibus et magnis dis* `{r} 5^5 |> format_to_md_latex() |> I()` parturient (@eq-taylor-expansion). Quam diu etiam furor iste tuus nos eludet?^[Fabio vel iudice vincam, sunt in culpa qui officia [@schelling1971].] Ut enim ad minim veniam, @sec-heading-5 (`@sec-heading-5`) or simply click [here](#sec-heading-5) (`[here](#sec-heading-5)`) quis nostrud exercitation [@fisher1932].
...
Petierunt uti sibi concilium totius Galliae in diem certam indicere. Morbi fringilla convallis sapien, id pulvinar odio volutpat (@eq-hypothesis-test). A communi observantia non est recedendum.
...
Non equidem invideo, miror magis posuere velit aliquet [@bulus]. Quisque placerat facilisis egestas cillum dolore [@popper2005a]. Curabitur blandit tempus ardua ridiculus sed magna [@redeglobo2017]. Contra legem facit qui id facit quod lex prohibet [@ropensci]. Petierunt uti sibi concilium totius Galliae in diem certam indicere [@watson1953].
