...
*Lorem ipsum dolor* sit amet, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Donec sed odio operae, eu vulputate felis **rhoncus** (`{r} pi |> format_to_md_latex("\\%") %>% paste0("n = ", .)`). Salutantibus vitae elit libero, a pharetra augue. Nihil hic munitissimus habendi senatus locus, nihil horum? A communi observantia non est recedendum [@einstein1905a].

### Heading 3 {#sec-heading-3}

Quisque ut dolor gravida, placerat libero vel, euismod. Ambitioni dedisse **scripsisse** $`{r} format(10^5, big.mark = ",")`$ iudicaretur. Donec sed odio operae, eu vulputate felis rhoncus. *Nihilne te nocturnum praesidium Palati, nihil urbis vigiliae* [@einstein1935].
...
Ab illo tempore, ab est sed immemorabili. *Cum sociis natoque penatibus et magnis dis* `{r} 5^5 |> format_to_md_latex()` parturient @eq-test. Quam diu etiam furor iste tuus nos eludet?^[Fabio vel iudice vincam, sunt in culpa qui officia [@schelling1971].] Ut enim ad minim veniam, @sec-heading-5 (`@sec-heading-5`) or simply click [here](#sec-heading-5) (`[here](#sec-heading-5)`) quis nostrud exercitation [@fisher1932].

##### Heading 5 {#sec-heading-5}

Ab illo tempore, ab est sed immemorabili. **Cum sociis natoque penatibus et magnis dis** $`{r} format(exp(1), big.mark = ",")`$ parturient (@cnj-hypothesis-test). Quam diu etiam furor iste tuus nos eludet? Ut enim ad minim veniam, quis nostrud exercitation [@neyman1928; @neyman1928a].
